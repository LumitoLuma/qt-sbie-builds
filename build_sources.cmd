if %1 == x64 (
    ...
    pushd %~dp0src\
    call configure.bat -release -opensource -confirm-license -prefix %~dp0bin\5.15.13\msvc2019_64 -platform win32-msvc -openssl-runtime OPENSSL_INCDIR="%~dp0src\openssl\include" -I "%~dp0src\openssl\include" -nomake tests -nomake examples -skip qtdoc -skip qtwebengine
    jom
...
if %1 == Win32 (
    ...
    pushd %~dp0src\
    call configure.bat -release -opensource -confirm-license -prefix %~dp0bin\5.15.13\msvc2019 -platform win32-msvc -openssl-runtime OPENSSL_INCDIR="%~dp0src\openssl\include" -I "%~dp0src\openssl\include" -nomake tests -nomake examples -skip qtdoc -skip qtwebengine
    jom
    if %ERRORLEVEL% == 0 jom install
